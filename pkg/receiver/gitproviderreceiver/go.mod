...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/golden v0.0.0-20231106174658-6696f7e77687
...
require github.com/open-telemetry/opentelemetry-collector-contrib/pkg/pdatautil v0.88.0 // indirect
