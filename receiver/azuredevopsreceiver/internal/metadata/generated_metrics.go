...
func (av AttributeVcsRefType) String() string {
	switch av {
	case AttributeVcsRefTypeBranch:
		return "branch"
	case AttributeVcsRefTypeTag:
		return "tag"
	}
	return ""
}
...
var MetricsInfo = metricsInfo{
	...
	VcsRefLinesDelta: metricInfo{
		...
		Attributes: []string{"vcs.repository.url.full", "vcs.repository.name", "vcs.repository.id", "vcs.ref.head.name", "vcs.ref.type", "vcs.ref.base.name", "vcs.ref.base.type", "vcs.line_change.type"},
	},
	...
	WorkItemAge: metricInfo{
		Name:       "work_item.age",
		Attributes: []string{"work_item.id", "work_item.type", "work_item.state", "project.name"},
	},
	...
	WorkItemCycleTime: metricInfo{
		...
		Attributes: []string{"work_item.id", "work_item.type", "project.name"},
	},
...
func (m *metricWorkItemAge) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, workItemIDAttributeValue string, workItemTypeAttributeValue string, workItemStateAttributeValue string, projectNameAttributeValue string) {
	if !m.config.Enabled {
		return
	}
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, WorkItemAgeMetricAttributeKeyWorkItemID) {
		dp.Attributes().PutStr("work_item.id", workItemIDAttributeValue)
	}
...
func (m *metricWorkItemCycleTime) recordDataPoint(start pcommon.Timestamp, ts pcommon.Timestamp, val int64, workItemIDAttributeValue string, workItemTypeAttributeValue string, projectNameAttributeValue string) {
	if !m.config.Enabled {
		return
	}
	...
	dp.SetStartTimestamp(start)
	dp.SetTimestamp(ts)
	if slices.Contains(m.config.EnabledAttributes, WorkItemCycleTimeMetricAttributeKeyWorkItemID) {
		dp.Attributes().PutStr("work_item.id", workItemIDAttributeValue)
	}
...
func (mb *MetricsBuilder) RecordVcsRefCountDataPoint(ts pcommon.Timestamp, val int64, vcsRepositoryURLFullAttributeValue string, vcsRepositoryNameAttributeValue string, vcsRepositoryIDAttributeValue string, vcsRefTypeAttributeValue AttributeVcsRefType) {
	mb.metricVcsRefCount.recordDataPoint(mb.startTime, ts, val, vcsRepositoryURLFullAttributeValue, vcsRepositoryNameAttributeValue, vcsRepositoryIDAttributeValue, vcsRefTypeAttributeValue.String())
}

// RecordVcsRefLinesDeltaDataPoint adds a data point to vcs.ref.lines_delta metric.
func (mb *MetricsBuilder) RecordVcsRefLinesDeltaDataPoint(ts pcommon.Timestamp, val int64, vcsRepositoryURLFullAttributeValue string, vcsRepositoryNameAttributeValue string, vcsRepositoryIDAttributeValue string, vcsRefHeadNameAttributeValue string, vcsRefTypeAttributeValue AttributeVcsRefType, vcsRefBaseNameAttributeValue string, vcsRefBaseTypeAttributeValue AttributeVcsRefBaseType, vcsLineChangeTypeAttributeValue AttributeVcsLineChangeType) {
	mb.metricVcsRefLinesDelta.recordDataPoint(mb.startTime, ts, val, vcsRepositoryURLFullAttributeValue, vcsRepositoryNameAttributeValue, vcsRepositoryIDAttributeValue, vcsRefHeadNameAttributeValue, vcsRefTypeAttributeValue.String(), vcsRefBaseNameAttributeValue, vcsRefBaseTypeAttributeValue.String(), vcsLineChangeTypeAttributeValue.String())
}

// RecordVcsRefRevisionsDeltaDataPoint adds a data point to vcs.ref.revisions_delta metric.
func (mb *MetricsBuilder) RecordVcsRefRevisionsDeltaDataPoint(ts pcommon.Timestamp, val int64, vcsRepositoryURLFullAttributeValue string, vcsRepositoryNameAttributeValue string, vcsRepositoryIDAttributeValue string, vcsRefHeadNameAttributeValue string, vcsRefTypeAttributeValue AttributeVcsRefType, vcsRevisionDeltaDirectionAttributeValue AttributeVcsRevisionDeltaDirection) {
	mb.metricVcsRefRevisionsDelta.recordDataPoint(mb.startTime, ts, val, vcsRepositoryURLFullAttributeValue, vcsRepositoryNameAttributeValue, vcsRepositoryIDAttributeValue, vcsRefHeadNameAttributeValue, vcsRefTypeAttributeValue.String(), vcsRevisionDeltaDirectionAttributeValue.String())
}

// RecordVcsRefTimeDataPoint adds a data point to vcs.ref.time metric.
func (mb *MetricsBuilder) RecordVcsRefTimeDataPoint(ts pcommon.Timestamp, val int64, vcsRepositoryURLFullAttributeValue string, vcsRepositoryNameAttributeValue string, vcsRepositoryIDAttributeValue string, vcsRefHeadNameAttributeValue string, vcsRefTypeAttributeValue AttributeVcsRefType) {
	mb.metricVcsRefTime.recordDataPoint(mb.startTime, ts, val, vcsRepositoryURLFullAttributeValue, vcsRepositoryNameAttributeValue, vcsRepositoryIDAttributeValue, vcsRefHeadNameAttributeValue, vcsRefTypeAttributeValue.String())
}
...
func (mb *MetricsBuilder) RecordWorkItemAgeDataPoint(ts pcommon.Timestamp, val int64, workItemIDAttributeValue string, workItemTypeAttributeValue string, workItemStateAttributeValue string, projectNameAttributeValue string) {
	mb.metricWorkItemAge.recordDataPoint(mb.startTime, ts, val, workItemIDAttributeValue, workItemTypeAttributeValue, workItemStateAttributeValue, projectNameAttributeValue)
}
...
func (mb *MetricsBuilder) RecordWorkItemCycleTimeDataPoint(ts pcommon.Timestamp, val int64, workItemIDAttributeValue string, workItemTypeAttributeValue string, projectNameAttributeValue string) {
	mb.metricWorkItemCycleTime.recordDataPoint(mb.startTime, ts, val, workItemIDAttributeValue, workItemTypeAttributeValue, projectNameAttributeValue)
}
