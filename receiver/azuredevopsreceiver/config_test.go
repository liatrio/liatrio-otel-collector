...
func TestLoadConfig(t *testing.T) {
	...
	defaultConfigazuredevopsscraper := factory.CreateDefaultConfig()
	defaultConfigazuredevopsscraper.(*Config).Scrapers = map[string]internal.Config{
		azuredevopsscraper.TypeStr: (&azuredevopsscraper.Factory{}).CreateDefaultConfig(),
	}

	assert.Equal(t, defaultConfigazuredevopsscraper, r0)
