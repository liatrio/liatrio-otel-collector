...
func TestMetricsBuilder(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			defaultMetricsCount++
			allMetricsCount++
			mb.RecordVcsChangeDurationDataPoint(ts, 1, "vcs.change.id-val", "vcs.repository.url.full-val", "vcs.repository.name-val", "vcs.repository.id-val", "vcs.ref.head.name-val", AttributeVcsChangeStateOpen)
			if tt.name == "reaggregate_set" {
				mb.RecordVcsChangeDurationDataPoint(ts, 3, "vcs.change.id-val-2", "vcs.repository.url.full-val-2", "vcs.repository.name-val-2", "vcs.repository.id-val-2", "vcs.ref.head.name-val-2", AttributeVcsChangeStateMerged)
			}
			defaultMetricsCount++
			allMetricsCount++
			mb.RecordVcsChangeTimeToApprovalDataPoint(ts, 1, "vcs.change.id-val", "vcs.repository.url.full-val", "vcs.repository.name-val", "vcs.repository.id-val", "vcs.ref.head.name-val")
			if tt.name == "reaggregate_set" {
				mb.RecordVcsChangeTimeToApprovalDataPoint(ts, 3, "vcs.change.id-val-2", "vcs.repository.url.full-val-2", "vcs.repository.name-val-2", "vcs.repository.id-val-2", "vcs.ref.head.name-val-2")
			}
			defaultMetricsCount++
			allMetricsCount++
			mb.RecordVcsChangeTimeToMergeDataPoint(ts, 1, "vcs.change.id-val", "vcs.repository.url.full-val", "vcs.repository.name-val", "vcs.repository.id-val", "vcs.ref.head.name-val")
			if tt.name == "reaggregate_set" {
				mb.RecordVcsChangeTimeToMergeDataPoint(ts, 3, "vcs.change.id-val-2", "vcs.repository.url.full-val-2", "vcs.repository.name-val-2", "vcs.repository.id-val-2", "vcs.ref.head.name-val-2")
			}
